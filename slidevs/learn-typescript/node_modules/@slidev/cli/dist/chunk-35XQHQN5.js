...
var require_iterator = _chunkMJQETB73js.__commonJS.call(void 0, {
...
var require_yallist = _chunkMJQETB73js.__commonJS.call(void 0, {
...
var require_lru_cache = _chunkMJQETB73js.__commonJS.call(void 0, {
...
var Queue = class {
  constructor() {
    _chunkMJQETB73js.__privateAdd.call(void 0, this, _head, void 0);
    _chunkMJQETB73js.__privateAdd.call(void 0, this, _tail, void 0);
    _chunkMJQETB73js.__privateAdd.call(void 0, this, _size, void 0);
    this.clear();
  }
  enqueue(value) {
    const node = new Node(value);
    if (_chunkMJQETB73js.__privateGet.call(void 0, this, _head)) {
      _chunkMJQETB73js.__privateGet.call(void 0, this, _tail).next = node;
      _chunkMJQETB73js.__privateSet.call(void 0, this, _tail, node);
    } else {
      _chunkMJQETB73js.__privateSet.call(void 0, this, _head, node);
      _chunkMJQETB73js.__privateSet.call(void 0, this, _tail, node);
    }
    _chunkMJQETB73js.__privateWrapper.call(void 0, this, _size)._++;
  }
  dequeue() {
    const current = _chunkMJQETB73js.__privateGet.call(void 0, this, _head);
    if (!current) {
      return;
    }
    _chunkMJQETB73js.__privateSet.call(void 0, this, _head, _chunkMJQETB73js.__privateGet.call(void 0, this, _head).next);
    _chunkMJQETB73js.__privateWrapper.call(void 0, this, _size)._--;
    return current.value;
  }
  clear() {
    _chunkMJQETB73js.__privateSet.call(void 0, this, _head, void 0);
    _chunkMJQETB73js.__privateSet.call(void 0, this, _tail, void 0);
    _chunkMJQETB73js.__privateSet.call(void 0, this, _size, 0);
  }
  get size() {
    return _chunkMJQETB73js.__privateGet.call(void 0, this, _size);
  }
  *[Symbol.iterator]() {
    let current = _chunkMJQETB73js.__privateGet.call(void 0, this, _head);
    while (current) {
      yield current.value;
...
// node/themes.ts
var import_semver2 = _chunkMJQETB73js.__toESM.call(void 0, require_semver2());
...
// node/addons.ts
var import_semver = _chunkMJQETB73js.__toESM.call(void 0, require_semver2());

async function getPackageJson(root) {
  try {
    const file = _chunk6ZL4B4HQjs.resolveImportPath.call(void 0, `${root}/package.json`, true);
...
function resolvePluginName(name) {
  ...
  if (isPath(name))
    return name;
  if (_chunk6ZL4B4HQjs.packageExists.call(void 0, `slidev-addon-${name}`))
...
function getClientRoot() {
  return _path.dirname.call(void 0, _chunk6ZL4B4HQjs.resolveImportPath.call(void 0, "@slidev/client/package.json", true));
}
function getCLIRoot() {
...
function resolveThemeName(name) {
  ...
  if (isPath(name))
    return name;
  if (_chunk6ZL4B4HQjs.packageExists.call(void 0, `@slidev/theme-${name}`))
    return `@slidev/theme-${name}`;
  if (_chunk6ZL4B4HQjs.packageExists.call(void 0, `slidev-theme-${name}`))
    return `slidev-theme-${name}`;
  if (_chunk6ZL4B4HQjs.packageExists.call(void 0, name))
    return name;
...
async function promptForThemeInstallation(name) {
  ...
  if (!name)
    return name;
  if (isPath(name) || _chunk6ZL4B4HQjs.packageExists.call(void 0, name))
    return name;
