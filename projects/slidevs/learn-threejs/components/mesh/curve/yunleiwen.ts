...
import { LineGeometry, LineMaterial, Line2 } from 'three/examples/jsm/Addons'
// 云雷纹（传统纹样）示例：由同心圆、小圆环与“回”字折线环绕组成
// Addons 中的 Line2/LineGeometry/LineMaterial 用于绘制可设置宽度的线段；需在外部设置 material.resolution 以使 linewidth 生效
export default function createMesh() {
  const group = new THREE.Group()

  // 内圈粗线圆环（Line2 支持像素级线宽）
  ...
  // 内圈细线圆环（BufferGeometry + LineBasicMaterial）
  ...
  // 第一圈“回”字折线图案，按 18°（π/10）等角度环绕，随角度旋转对齐
